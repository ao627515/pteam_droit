                        ...
                        <div class="header-menu">
                            <ul>
                                ...
                                <li class="{{ Request::routeIs('categorieArticle.show') ? 'active' : '' }}">
                                    <a href="#">Publications <i class="fas fa-caret-down"></i></a>
                                    <ul>
                                        @php
                                        ...
                                        @foreach ($categories as $categorie)
                                            <li>
                                                <a
                                                    href="{{ route('categorieArticle.show', $categorie->id) }}">{{ $categorie->nom }}</a>
                                            </li>
                                        @endforeach
                                    </ul>
                                </li>
                                <li class="{{ Request::routeIs('partenaire.index') ? 'active' : '' }}">
                                    <a href="{{ route('partenaire.index') }}">Partenaire</a>
                                </li>
                    ...
                    @if (Auth::user())
                        <div class="header-menu">
                            <ul class="text-right m-0" data-animate="fadeInUp" data-delay=".5">
                                <li>
                                    <a class="btn btn-primary p-2 text-white" href="#">{{ Auth::user()->prenom }}
                                        <i class="fas fa-caret-down"></i>
                                    </a>
                                    <ul>
