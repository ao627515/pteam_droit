...
@section('content')
                ...
                <div class="col-lg-6">
                    ...
                    <div class="banner-content">
                        ...
                        <ul class="list-inline" data-animate="fadeInUp" data-delay="1.4">
                            ...
                            @if (Auth::user())
                                <li><a href="{{ route('ticket.create', ['q' => 0]) }}"
                                        class="btn btn-primary p-2 text-white">Demander assistance<i
                                            class="fas fa-caret-right"></i></a></li>
                            @else
                                <li><button onclick="goToPlan()" class="btn btn-danger">Créer un compte</button></li>
                                <li><a href="{{ route('auth.loginform') }}" class="btn btn-primary p-2 text-white">Se
                                        connecter<i class="fas fa-caret-right"></i></a></li>
                            @endif
                        </ul>
                    </div>
                </div>
                        ...
                        <div id="carouselExampleControls" id="carousel1" class="carousel slide" data-ride="carousel"
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block w-100" src="{{ asset('assets/img/justice3.jpg') }}"
                                        style="height: 450px" alt="First slide">
                                    <div class="carousel-caption d-none d-md-block  bg-light" style="opacity: 0.8;">
                                        <h5>Carousel 1 </h5>
                                ...
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{ asset('assets/img/justice1.png') }}"
                                        style="height: 450px" alt="First slide">
                                    <div class="carousel-caption d-none d-md-block  bg-light" style="opacity: 0.8;">
                                        <h5>Carousel 1 </h5>
                                        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. </p>
            ...
            <div class="row align-items-lg-end">
                <div class="col-md-12">
                    <div class="section-title">
                        <h2 data-animate="fadeInUp" data-delay=".1" class="text-primary">Comment pouvons nous vous aidez
                            ?
                        </h2>
                        <p data-animate="fadeInUp" data-delay=".2" class="text-danger">Selectionnez votre préocupation
                            dans
                            la liste ci-dessous et l'un de nos expert vous assistera au plus vite </p>
                    </div>
    ...
    <section class="mt-3">
        <div class="container">
            ...
            <!-- carousel -->
            <div id="carouselExampleControls" id="carousel2" class="carousel slide carousel-fade" data-ride="carousel"
                data-interval="2000">
                ...
                <div class="row">
                    <div class="col-lg-5">
                        ...
                        <div class="section-title">
                            ...
                            <p data-animate="fadeInUp" data-delay=".3" class="text-light">Lorem ipsum dolor sit amet
                                consectetur
                                adipisicing
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5">
                        ...
                        <div class="pricing-features">
                            <h3 class="cabin text-light" data-animate="fadeInUp" data-delay=".5">Votre inscription vous
                                donne droit
                                aux
                            ...
                            <ul class="list-unstyled list-item clearfix">
                                ...
                                <li data-animate="fadeInUp" data-delay=".35"><i class="fas fa-check-circle"></i>Suivit
                                    de
                                    .....</li>
                                <li data-animate="fadeInUp" data-delay=".4"><i class="fas fa-check-circle"></i>Protection
                                    ......</li>
                            ...
                            <a href="{{ route('auth.registerform', ['t' => 'partenaire']) }}"
                                class="text-primary bg-light mt-2 p-2" data-animate="fadeInUp" data-delay=".7">Proposer
                                mes services en tant que partenaire <i class="fas fa-caret-right"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="swiper-slide single-pricing-slide">
                                    <div class="single-pricing-plan">
                                        <img src="{{ asset('assets/img/icons/bandwidth.svg') }}" alt=""
                                            alt="" data-no-retina class="svg">
                                        ...
                                        <a href="{{ route('auth.registerform', ['t' => 'physique']) }}"
                                            class="btn btn-primary">Souscrire</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="swiper-slide single-pricing-slide">
                                    <div class="single-pricing-plan">
                                        <img src="{{ asset('assets/img/icons/enterprise.svg') }}" alt=""
                                            alt="" data-no-retina class="svg">
                                        ...
                                        <a href="{{ route('auth.registerform', ['t' => 'morale']) }}"
                                            class="btn btn-primary">Souscrire</a>
                                    </div>
                                </div>
                            </div>
    ...
    <section class="pt-7 pb-5-5">
        <div class="container">
            ...
            <div class="row">
                ...
                @endforeach
                <div class="col-md-12 text-right"> <a href="{{ route('article.index') }}" class="btn btn-default">Voir
                        plus</a></div>
            </div>
        </div>
    </section>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-8">
                        ...
                        <div class="section-title text-center">
                            ...
                            <p class="text-white" data-animate="fadeInUp" data-delay=".3">Nous reunissons les meilleurs
                                sur notre plateforme afin de vous proposser le meilleur service qu'il soit</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="services-wrap bg-primary position-relative pt-5 pb-5">
            <div class="container">
                ...
                <div class="row">
                            ...
                            <div class="single-member" data-animate="fadeInUp" data-delay="0">
                                <div class="image-hover-wrap">
                                    ...
                                    <div
                                        class="image-hover-content d-flex justify-content-center align-items-center text-center">
                                        <ul class="list-inline">
                                            <li><a href="{{ route('organisation.show', $item->id) }}"><i
                                ...
                                <div class="single-member-info bg-light">
                                    ...
                                    <a href="{{ route('organisation.show', $item->id) }}"
                                        class="btn btn-link text-warning">Consulter <i class="fas fa-caret-right"></i></a>
                                </div>
                            </div>
                        </div>
                    @endforeach
                    ...
                    <div class="col-md-12 text-right"> <a href="{{ route('partenaire.index') }}"
                            class="btn btn-default">Voir plus</a></div>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-5">
                    <div class="section-title">
                        ...
                        <p data-animate="fadeInUp" data-delay=".2" class="text-info">Nos spécialistes sont repartis et
                            competent pour
