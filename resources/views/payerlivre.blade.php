...
<body>
        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-7">
            <div class="card-header">
                <h2 class="text-prmiary">paiement d'oeuvre </h2>
            </div>
  ...
  <div class="row mx-md-5 mt-3 p-3 border bg-light" id="pay_form">
    <div class="col-12 p-3 mb-3 text-center bg-white">
        ...
        <small>Pour orange-money</small> <br>
        <a href="tel:000" class="btn btn-link" title="composer">*144*6*4251*numero*montant#</a> <br>
        <small>Pour moov-money</small> <br>
        <a href="tel:000" class="btn btn-link" title="composer">*555*6*4251*numero*montant#</a> <br>
