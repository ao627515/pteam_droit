                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-7 p-5">
                        <div class="card-body p-5">
                            ...
                            <p class="login-card-description text-center">Remplissez ce formulaire pour demander une
                                assistance</p>
                            ...
                            <form action="{{ route('ticket.store') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    @if (count($prestations) > 0)
                                        <select class="custom-select form-control @error('objet') is-invalid @enderror"
                                            name="objet" id="objet" placeholder="Choisir"Ò
                                            value="{{ old('objet') }}">
                                            @foreach ($prestations as $prestation)
                                                <option value="{{ $prestation->id }}"
                                                    {{ $q == $prestation->id ? 'selected' : '' }}>
                                                    {{ $prestation->nom }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('msg') is-invalid @enderror" name="msg" id="msg"
                                        value="{{ old('msg') }}" placeholder="Decrivez brievement votre demande" cols="30" rows="6"></textarea>
                                    @error('msg')
